...
// SVG icons inline — zero external dependency, perfectly secure
const InstagramIcon = () => (
  ...
  return (
    <footer className="footer" role="contentinfo">
      ...
      <div className="footer-top">
        <div>
          <p className="footer-brand-name">SCALEVO</p>
          <p className="footer-tagline">No es suerte. Es sistema.</p>
        </div>

        <nav className="footer-links" aria-label="Footer navigation">
          <Link href="#services"    className="footer-link">Servicios</Link>
          <Link href="#evidence"    className="footer-link">Resultados</Link>
          <Link href="#manifesto"   className="footer-link">Filosofía</Link>
          <Link href="#diagnostic"  className="footer-link">Diagnóstico</Link>
          <Link href="mailto:hola@scalevo.com" className="footer-link">hola@scalevo.com</Link>
        </nav>
      </div>
